...
export async function generateMetadata({params}:Props):Promise<Metadata>{
 ...
 const description=service?.description||(region?`Möbelmontage in ${region.name}: Küchen, Schränke, IKEA Möbel und PAX sorgfältig aufbauen lassen. Persönlicher Service in ${region.districts.join(', ')} und Umgebung.`:slug==='gewerbekunden'?'Montageservice für Unternehmen: Büro- und Betriebsmöbel, Regale, Verkaufsflächen sowie Waren- und Präsentationsständer. Einmalige Aufträge und langfristige Zusammenarbeit.':`${route.title}. Persönlicher Montageservice von Andrii Ryndia Solutions im Saarland.`);
